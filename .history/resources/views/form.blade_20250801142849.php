...
<body class="min-h-screen py-8" style="background: linear-gradient(135deg, #f8fafc 0%, rgba(28,88,113,0.05) 50%, rgba(42,122,157,0.08) 100%);">
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 border" style="border-color: rgba(28,88,113,0.1);">
            ...
            <div class="text-center mb-8">
                <div class="professional-gradient p-6 rounded-2xl mb-6">
                    ...
                    <p class="text-blue-100">Buat soal pilihan ganda dengan bantuan teknologi KemenLH/BPLH</p>
                </div>
            </div>
