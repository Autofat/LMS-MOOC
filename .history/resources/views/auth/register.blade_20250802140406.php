...
<body class="dynamic-background min-h-screen flex items-center justify-center py-8">
    ...
    <div class="max-w-md w-full mx-auto px-4 relative z-10">
        <div class="glass-card rounded-2xl shadow-2xl">
            ...
            <!-- Body -->
            <div class="p-8" style="background: rgba(255,255,255,0.95); backdrop-filter: blur(10px);">
                <!-- Success Message -->
                @if(session('success'))
                    <div class="px-4 py-3 rounded-xl mb-6 flex items-center space-x-3" style="background: linear-gradient(135deg, rgba(34,197,94,0.15) 0%, rgba(16,185,129,0.12) 100%); border: 1px solid rgba(34,197,94,0.3); color: rgba(5,150,105,0.9); backdrop-filter: blur(10px);">
