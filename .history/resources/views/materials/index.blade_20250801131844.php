...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen subtle-pattern">
        ...
        <div class="container mx-auto px-4">
            <div class="text-center">
                ...
                <h1 class="text-4xl md:text-5xl font-bold mb-4">
                    Platform Pembuatan Soal Generator
                </h1>
                <p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                    Sistem otomatis untuk membuat soal dari materi pembelajaran dengan teknologi modern dan efisien
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ route('questions.manage') }}"
                        ...
                        <i class="fas fa-robot mr-2"></i>Kelola Soal
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 pb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-indigo-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm text-gray-600">Soal Generated</p>
        ...
        @else
            ...
            <div class="bg-white/95 backdrop-blur-sm shadow-xl rounded-3xl p-12 text-center border border-blue-100">
                <div class="text-blue-500 mb-6">
                    <div class="bg-blue-100 rounded-full p-8 inline-block">
                        <i class="fas fa-brain text-5xl text-blue-600"></i>
                    </div>
                </div>
                <h3 class="text-2xl font-bold text-gray-800 mb-4">Mulai Dengan AI Generator</h3>
                <p class="text-gray-600 mb-8 max-w-md mx-auto">
                    Belum ada materi untuk diproses. Upload materi pembelajaran dan biarkan AI membuat soal secara otomatis dengan teknologi machine learning terbaru.
                </p>

                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('materials.create') }}"
                        class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg">
                        <i class="fas fa-plus mr-2"></i>Upload Materi Pertama
                    </a>
                    <a href="{{ route('questions.manage') }}"
                        class="bg-white border-2 border-blue-500 text-blue-600 hover:bg-blue-50 font-bold py-3 px-8 rounded-full transition-all duration-300">
                        <i class="fas fa-robot mr-2"></i>Kelola Soal AI
                    </a>
                </div>
                
                <!-- Decorative Elements -->
                <div class="mt-8 flex justify-center space-x-4 text-blue-300">
