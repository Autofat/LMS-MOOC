                                            ...
                                            <div class="bg-yellow-50 p-3 rounded border-l-4 border-yellow-400 mt-3">
                                                <p class="text-sm text-yellow-800">
                                                    ...
                                                    @php
                                                        ...
                                                        if ($difficulty === 'Mudah' || $difficulty === 'easy' || $difficulty === 'mudah') {
                                                            $bgStyle = 'background: rgba(34,197,94,0.12); color: rgba(21,128,61,0.9);';
                                                        } elseif ($difficulty === 'Menengah' || $difficulty === 'medium' || $difficulty === 'menengah') {
                                                            $bgStyle = 'background: rgba(251,191,36,0.12); color: rgba(180,83,9,0.9);';
                                                        } elseif ($difficulty === 'Sulit' || $difficulty === 'hard' || $difficulty === 'sulit') {
