...
<head>
    ...
    <title>Kelola Materi - PPSDM MOOC Platform</title>
                ...
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border" style="border-color: rgba(28,88,113,0.2);">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold" style="color: rgba(28,88,113,1);">{{ $materials->whereNotNull('category')->groupBy('category')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
