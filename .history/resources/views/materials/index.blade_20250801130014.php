                ...
                @foreach ($materials as $material)
                    <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-teal-100">
                        ...
                        <div class="p-6">
                            ...
                            <!-- File Info with Theme Icons -->
                            <div class="flex items-center text-sm text-gray-500 mb-4 bg-teal-50 p-3 rounded-lg">
                            ...
                            <div class="flex items-center justify-between text-sm text-gray-500 mb-4">
                                <div class="flex items-center">
                                    <i class="fas fa-weight text-teal-500 mr-1"></i>
                            ...
                            <div class="text-xs text-gray-400 mb-4 flex items-center">
                                <i class="fas fa-calendar text-teal-400 mr-1"></i>
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('materials.show', $material->id) }}"
                                    class="flex-1 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white text-center py-2 px-3 rounded-lg text-sm transition-all duration-300 transform hover:scale-105">
                                    <i class="fas fa-eye mr-1"></i>Detail
                                </a>
                                <a href="{{ route('materials.download', $material->id) }}"
                                    class="flex-1 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white text-center py-2 px-3 rounded-lg text-sm transition-all duration-300 transform hover:scale-105">
