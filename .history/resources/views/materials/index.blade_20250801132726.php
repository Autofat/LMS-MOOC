            ...
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ route('questions.manage') }}"
                        class="bg-rgba(28,88,113,0.8) hover:bg-rgba(28,88,113,1) text-white font-bold py-3 px-6 rounded-full transition-all duration-300 transform hover:scale-105">
