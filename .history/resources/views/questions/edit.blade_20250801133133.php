            ...
            <form method="POST" action="{{ route('questions.update', $question->id) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <select id="material_id" name="material_id"
                        ...
                        style="border-color: rgba(28,88,113,0.2); background: linear-gradient(135deg, rgba(28,88,113,0.03) 0%, rgba(42,122,157,0.05) 100%); focus:border-color: rgba(28,88,113,0.5);">
