...
<head>
    ...
    <title>Kelola Soal - PPSDM MOOC Platform</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <style>
        .professional-gradient {
            background: linear-gradient(135deg, rgba(28,88,113,0.85) 0%, rgba(34,108,137,0.9) 40%, rgba(42,122,157,0.85) 70%, rgba(52,211,153,0.8) 100%);
        }
        ...
        body {
            background-image: 
                radial-gradient(circle at 20% 80%, rgba(28,88,113,0.08) 0%, transparent 50%),
                radial-gradient(circle at 80% 20%, rgba(52,211,153,0.08) 0%, transparent 50%),
                radial-gradient(circle at 40% 40%, rgba(34,108,137,0.06) 0%, transparent 50%);
        }
    </style>
</head>
