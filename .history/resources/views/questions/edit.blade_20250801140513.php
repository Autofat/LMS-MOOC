            ...
            <form method="POST" action="{{ route('questions.update', $question->id) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <select id="difficulty" name="difficulty" 
                        ...
                        <option value="Mudah" {{ old('difficulty', $question->difficulty) == 'Mudah' || old('difficulty', $question->difficulty) == 'easy' ? 'selected' : '' }}>Mudah</option>
                        <option value="Menengah" {{ old('difficulty', $question->difficulty) == 'Menengah' || old('difficulty', $question->difficulty) == 'medium' ? 'selected' : '' }}>Menengah</option>
                        <option value="Sulit" {{ old('difficulty', $question->difficulty) == 'Sulit' || old('difficulty', $question->difficulty) == 'hard' ? 'selected' : '' }}>Sulit</option>
                    </select>
                    @error('difficulty')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    ...
                    <div class="text-sm" style="color: rgba(28,88,113,0.6);">
                        ...
                        @if ($question->difficulty)
                            ...
                            <p><i class="fas fa-layer-group mr-1"></i>Kesulitan: <span
                                    class="inline-block {{ $bgClass }} {{ $textClass }} text-xs px-2 py-1 rounded-full font-medium">{{ ucfirst($question->difficulty) }}</span>
                            </p>
                        @endif
                    </div>
