...
<body class="bg-gray-50">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="option_a" class="block text-sm font-medium text-gray-700 mb-2">
                                    <span class="bg-blue-500 text-white px-2 py-1 rounded text-xs mr-1">A</span>
                                    Pilihan A
                                </label>
                            ...
                            <div>
                                <label for="option_b" class="block text-sm font-medium text-gray-700 mb-2">
                                    <span class="bg-green-500 text-white px-2 py-1 rounded text-xs mr-1">B</span>
                                    Pilihan B
                                </label>
                            ...
                            <div>
                                <label for="option_c" class="block text-sm font-medium text-gray-700 mb-2">
                                    <span class="bg-yellow-500 text-white px-2 py-1 rounded text-xs mr-1">C</span>
                                    Pilihan C
                                </label>
    ...
    <script>
        ...
        // Clear session notifications after page load
        @if (session('success'))
            setTimeout(() => {
