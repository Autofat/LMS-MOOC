...
<div id="toastContainer" class="fixed top-4 right-4 z-50 space-y-2">
    @if(session('success'))
        <div id="successToast" class="bg-green-500 text-white px-6 py-4 rounded-lg shadow-lg max-w-sm transform translate-x-full opacity-0 transition-all duration-500 ease-in-out">
    ...
    @if(session('error'))
        <div id="errorToast" class="bg-red-500 text-white px-6 py-4 rounded-lg shadow-lg max-w-sm transform translate-x-full opacity-0 transition-all duration-500 ease-in-out">
            <div class="flex items-center">
                <div class="flex-shrink-0">
    ...
    @if(session('info'))
        <div id="infoToast" class="bg-blue-500 text-white px-6 py-4 rounded-lg shadow-lg max-w-sm transform translate-x-full opacity-0 transition-all duration-500 ease-in-out">
            <div class="flex items-center">
                <div class="flex-shrink-0">
