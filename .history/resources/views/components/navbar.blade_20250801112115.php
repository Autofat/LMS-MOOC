    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center py-4">
            ...
            <div class="flex items-center space-x-3 mr-8">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-800">KemenLH/BPLH E-Learning Platform</h1>
                </div>
            </div>
...
@if(session('success'))
    <div id="successMessage" class="container mx-auto px-4 mb-6">
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg shadow-sm transition-opacity duration-500">
...
@if(session('error'))
    <div id="errorMessage" class="container mx-auto px-4 mb-6">
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg shadow-sm transition-opacity duration-500">
            <div class="flex items-center">
...
@if(session('info'))
    <div id="infoMessage" class="container mx-auto px-4 mb-6">
        <div class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded-lg shadow-sm transition-opacity duration-500">
            <div class="flex items-center">
...
document.addEventListener('DOMContentLoaded', function() {
    // Auto-hide session messages after 4 seconds
    ...
    // Apply auto-hide to all message types
    autoHideMessage('successMessage');
    autoHideMessage('errorMessage');
    autoHideMessage('infoMessage');
