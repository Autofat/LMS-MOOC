<!-- Navigation Bar -->
<nav class="shadow-xl border-b mb-8" style="background: linear-gradient(135deg, rgba(28,88,113,1) 0%, rgba(35,105,135,1) 50%, rgba(42,122,157,1) 100%); border-color: rgba(28,88,113,0.6);">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    <button id="userMenuButton" class="flex items-center space-x-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 rounded-full px-3 py-2 transition-colors border border-white/30">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center text-white font-semibold text-sm" style="background: linear-gradient(135deg, rgba(28,88,113,0.8) 0%, rgba(42,122,157,0.8) 100%);">
                    ...
                    <!-- Dropdown Menu -->
                    <div id="userDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl z-50 backdrop-blur-sm" style="border: 1px solid rgba(28,88,113,0.2);">
                        <div class="py-2">
                            <div class="px-4 py-2 border-b" style="border-color: rgba(28,88,113,0.1);">
                                <p class="text-sm font-semibold text-gray-800">{{ Auth::user()->name }}</p>
                                <p class="text-xs text-gray-600">{{ Auth::user()->email }}</p>
                            </div>
                            <a href="{{ route('materials.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors" style="hover:background-color: rgba(28,88,113,0.05);">
                                <i class="fas fa-home mr-2" style="color: rgba(28,88,113,1);"></i>Dashboard
                            </a>
                            <a href="{{ route('test.n8n.connection') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors" style="hover:background-color: rgba(28,88,113,0.05);">
                                <i class="fas fa-cogs mr-2" style="color: rgba(28,88,113,1);"></i>Test Sistem
                            </a>
