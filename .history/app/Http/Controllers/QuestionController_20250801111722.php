...
public function store(Request $request)
{
    ...
    // Redirect to material detail page if material_id exists, otherwise to questions.create
    if ($request->material_id) {
        return redirect()->route('materials.show', $request->material_id)->with('success', 'Soal berhasil disimpan!');
    }
    
    return redirect()->route('questions.create')->with('success', 'Soal berhasil disimpan!');
}
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($question->material_id) {
            return redirect()->route('materials.show', $question->material_id)->with('success', 'Soal berhasil diupdate!');
        }
