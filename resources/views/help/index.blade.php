...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen subtle-pattern">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <!-- Header -->
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border p-8 mb-8"
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border p-8 mb-8"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="help-card bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 border"
                    style="border-color: rgba(28,88,113,0.1);">
                ...
                <div class="help-card bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border"
                    style="border-color: rgba(28,88,113,0.1);">
                    <div class="text-center">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg border p-6"
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start space-x-3">
                        <span class="bg-gray-100 text-gray-800 text-xs font-semibold px-2 py-1 rounded-full">4</span>
                        <p class="text-sm text-gray-600">Soal akan otomatis tersimpan dan bisa dilihat di menu "Kelola
                            Soal"</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg border p-6"
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start space-x-3">
                        <span class="bg-gray-100 text-gray-800 text-xs font-semibold px-2 py-1 rounded-full">4</span>
                        <p class="text-sm text-gray-600">Gunakan tombol hapus untuk menghilangkan soal yang tidak
                            diperlukan</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg border p-6"
                ...
                <div class="space-y-3">
                    <div class="bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded">
                        <p class="text-sm text-gray-700"><strong>Format File:</strong> Gunakan PDF dengan teks yang
                            jelas, hindari gambar scan untuk hasil terbaik</p>
                    </div>
                    <div class="bg-blue-50 border-l-4 border-blue-400 p-3 rounded">
                        <p class="text-sm text-gray-700"><strong>Kategorisasi:</strong> Kelompokkan materi berdasarkan
                            topik untuk memudahkan pencarian</p>
                    </div>
                    <div class="bg-green-50 border-l-4 border-green-400 p-3 rounded">
                        <p class="text-sm text-gray-700"><strong>Review Soal:</strong> Selalu review soal yang
                            di-generate untuk memastikan kualitas</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- FAQ Section -->
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border p-8 mt-8"
            style="border-color: rgba(28,88,113,0.1);">
            <h2 class="text-2xl font-bold mb-6" style="color: rgba(28,88,113,1);">
            ...
            <div class="space-y-4">
                <div class="border-b border-gray-200 pb-4">
                    <button class="faq-toggle w-full text-left flex justify-between items-center py-2"
                        onclick="toggleFAQ(this)">
                        <span class="font-semibold text-gray-800">Bagaimana cara mengunduh soal yang telah
                            dibuat?</span>
                        <i class="fas fa-chevron-down transform transition-transform"></i>
                    </button>
                    <div class="faq-content hidden mt-2 text-gray-600">
                        <ul class="list-disc list-inside space-y-1 text-sm">
                            <li><strong>Download Soal dari Materi:</strong> Di halaman detail materi, klik "Download
                                Soal" untuk mengunduh soal-soal yang terkait dengan materi tersebut dalam format Excel.
                            </li>
                            <li><strong>Download Soal dari Kategori:</strong> Di halaman kategori, klik "Download Soal"
                                untuk mengunduh semua soal dari kategori tersebut dalam format Excel.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-200 pb-4">
                    ...
                    <div class="faq-content hidden mt-2 text-gray-600">
                        <p>Klik menu "Kategori" di navbar, kemudian pilih "Tambah Kategori Baru". Isi nama kategori dan
                            deskripsi, lalu klik "Simpan Kategori". Kategori baru akan langsung tersedia untuk digunakan
                            saat upload materi.</p>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-200 pb-4">
                    <button class="faq-toggle w-full text-left flex justify-between items-center py-2"
                        onclick="toggleFAQ(this)">
                        <span class="font-semibold text-gray-800">Apakah ada batasan ukuran file yang bisa
                            diupload?</span>
                        <i class="fas fa-chevron-down transform transition-transform"></i>
                    </button>
                    <div class="faq-content hidden mt-2 text-gray-600">
                        <p>Ya, ukuran maksimal file yang bisa diupload adalah 10MB. Pastikan file PDF Anda tidak
                            melebihi batas ini.</p>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-200 pb-4">
                    ...
                    <div class="faq-content hidden mt-2 text-gray-600">
                        <p>Proses generate soal biasanya memakan waktu 1-3 menit tergantung panjang materi. Sistem akan
                            memberikan notifikasi ketika proses selesai.</p>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-200 pb-4">
                    <button class="faq-toggle w-full text-left flex justify-between items-center py-2"
                        onclick="toggleFAQ(this)">
                        <span class="font-semibold text-gray-800">Bisakah saya mengedit soal yang sudah
                            di-generate?</span>
                        <i class="fas fa-chevron-down transform transition-transform"></i>
                    </button>
                    <div class="faq-content hidden mt-2 text-gray-600">
                        <p>Tentu saja! Anda bisa mengedit semua aspek dari soal yang sudah di-generate, termasuk
                            pertanyaan, pilihan jawaban, dan jawaban yang benar.</p>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-200 pb-4">
                    <button class="faq-toggle w-full text-left flex justify-between items-center py-2"
                        onclick="toggleFAQ(this)">
                        <span class="font-semibold text-gray-800">Bagaimana cara menghapus materi yang sudah
                            diupload?</span>
                        <i class="fas fa-chevron-down transform transition-transform"></i>
                    </button>
                    <div class="faq-content hidden mt-2 text-gray-600">
                        <p>Buka detail materi, lalu klik tombol "Hapus Materi". Perhatian: menghapus materi akan
                            menghapus semua soal yang terkait dengan materi tersebut.</p>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-200 pb-4">
                    ...
                    <div class="faq-content hidden mt-2 text-gray-600">
                        <p>Ya, tentu saja! Anda bisa membuat soal secara manual dengan pilih "Tambah Soal Baru". Isi
                            pertanyaan, pilihan jawaban, dan tentukan jawaban yang benar. Soal manual ini akan tersimpan
                            bersama dengan soal-soal yang di-generate otomatis.</p>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-200 pb-4">
                    ...
                    <div class="faq-content hidden mt-2 text-gray-600">
                        <p>Tidak ada format khusus, tapi untuk hasil terbaik gunakan PDF dengan teks yang bisa dicopy
                            (bukan hasil scan gambar). Pastikan teks mudah dibaca dan terstruktur dengan baik.</p>
                    </div>
                </div>
            </div>
        </div>
