                ...
                <div class="relative">
                    ...
                    <div id="userDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl z-50 backdrop-blur-sm" style="border: 1px solid rgba(28,88,113,0.2);">
                        <div class="py-2">
                            ...
                            <a href="{{ route('materials.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                <i class="fas fa-home mr-2" style="color: rgba(28,88,113,1);"></i>Dashboard
                            </a>
                            <a href="{{ route('test.n8n.connection') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
