                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <form method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="option_d" class="block text-sm font-medium mb-2" style="color: rgba(28,88,113,0.9);">
                                    <span class="text-white px-2 py-1 rounded text-xs mr-1" style="background: rgba(28,88,113,1);">D</span>
                                    Pilihan D
                                </label>
                        ...
                        <div>
                            <label for="answer" class="block text-sm font-medium mb-2" style="color: rgba(28,88,113,0.9);">
                        ...
                        <div>
                            <label for="explanation" class="block text-sm font-medium mb-2" style="color: rgba(28,88,113,0.9);">
