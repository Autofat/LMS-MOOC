...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen subtle-pattern">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <!-- User List -->
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border p-8"
            style="border-color: rgba(28,88,113,0.1);">
            <!-- Informasi User -->
            <div class="mt-8 p-4 rounded-xl"
                style="background: rgba(28,88,113,0.05); border: 1px solid rgba(28,88,113,0.1);">
            ...
            @if ($admins->count() > 0)
                <div class="grid gap-6">
                    @foreach ($admins as $admin)
                        <div class="border rounded-2xl p-6 hover:shadow-lg transition-all duration-300"
                            style="border-color: rgba(28,88,113,0.1); background: linear-gradient(135deg, rgba(28,88,113,0.02) 0%, rgba(35,105,135,0.02) 100%);">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-800">
                                            ...
                                            @if ($admin->id === Auth::id())
                                                <span
                                                    class="text-sm bg-blue-100 text-blue-800 px-2 py-1 rounded-full ml-2">Anda</span>
                                            @endif
                                        </h3>
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4">
            <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all"
                style="border: 1px solid rgba(28,88,113,0.1);">
                <!-- Header -->
                ...
                <div class="p-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 mb-4">
                        <div class="flex items-center space-x-4">
                            <div class="relative">
                                <div
                                    class="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg professional-gradient">
