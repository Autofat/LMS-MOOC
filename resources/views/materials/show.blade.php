...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen subtle-pattern">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-4">
            @if (
                (request('from') === 'subcategory' || (isset($from) && $from === 'subcategory')) &&
                    (request('subcategory_id') || (isset($subcategoryId) && $subcategoryId)))
        ...
        <!-- Header -->
        <div class="mb-8 glass-effect rounded-2xl p-6 shadow-xl">
            <div>
    ...
    <div id="progressModal"
        ...
        <div class="relative top-20 mx-auto p-6 border w-96 shadow-2xl rounded-2xl glass-effect">
            <div class="text-center">
                ...
                <h3 class="text-xl font-semibold mb-4" style="color: rgba(28,88,113,0.9);">Sedang Membuat Soal...</h3>
                <div class="mb-6">
    ...
    <script>
        ...
        async function triggerN8nGeneration(materialId, questionCount, difficulty) {
            try {
                ...
                const generateUrl = "{{ route('materials.generate-questions-async', ['id' => ':id']) }}".replace(':id',
                    materialId);
